...
public interface TargetRelease extends PersistableObject {
  ...
  /**
   * Returns the start date for the developers to start coding for this release.
   *
  ...
  /**
   * Returns the final live date of the software release. If this field is set,
   * no changes can be performed to the involved tasks.
   *
